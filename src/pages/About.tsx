  ...
  return (
    <div className="min-h-screen bg-white px-4 sm:px-6 py-8 sm:py-12">
      ...
      <section className="mx-auto max-w-5xl text-center">
        ...
        <p className="mx-auto max-w-2xl text-gray-600 text-base sm:text-lg leading-7">
      ...
      {/* Our Story */}
      <section className="mx-auto mt-12 sm:mt-16 max-w-5xl grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-10 items-center">
        ...
        <div className="rounded-2xl bg-amber-50 p-8 sm:p-10 text-center">
      ...
      {/* Mission */}
      <section className="mx-auto mt-12 sm:mt-16 max-w-5xl text-center">
        <h2 className="text-2xl sm:text-3xl font-semibold mb-4">
          Our Mission
        </h2>
      ...
      {/* Why Choose Us */}
      <section className="mx-auto mt-12 sm:mt-16 max-w-5xl">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 sm:gap-6">
          ...
          <div className="rounded-2xl border p-5 sm:p-6 text-center shadow-sm">
      ...
      {/* CTA */}
      <section className="mx-auto mt-12 sm:mt-16 max-w-5xl rounded-2xl sm:rounded-3xl bg-amber-50 p-7 sm:p-10 text-center">
        ...
        <a
          href="/shop"
          className="inline-block rounded-full bg-black px-6 sm:px-7 py-3 text-white transition hover:bg-gray-800"
        >
          Shop Now
        </a>
